...
describe("PerformanceReportService", () => {
  ...
  describe("Automated Reporting", () => {
    ...
    it("should restart reporting when configuration is updated", () => {
      ...
      expect(PerformanceReportService.reportSchedule).not.toBe(
        originalSchedule
      );
      expect(PerformanceReportService.getConfig().interval).toBe(
        12 * 60 * 60 * 1000
      );
    });
  });
  ...
  describe("Metrics Analysis", () => {
    ...
    it("should detect slow database queries", async () => {
      const slowQueryMetrics = {
        ...sampleMetrics,
        analysis: {
          slowQueries: [{ query: "SELECT * FROM users", duration: 5000 }],
        },
      };
  ...
  describe("Configuration Management", () => {
    ...
    it("should update configuration", () => {
      ...
      expect(updatedConfig.alertThresholds.errorRate).toBe(
        newConfig.alertThresholds.errorRate
      );
    });
