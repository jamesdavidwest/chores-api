...
router.post('/register',
    validateSchema(userSchemas.registerUser),
    async (req, res, next) => {
        try {
...
router.post('/login',
    validateSchema(userSchemas.loginUser),
    async (req, res, next) => {
        try {
...
// PUT /api/v1/users/:id
router.put('/:id',
    validateSchema(userSchemas.updateUser),
    async (req, res, next) => {
        try {
...
router.post('/refresh-token',
    validateSchema(userSchemas.refreshToken),
    async (req, res, next) => {
        try {
