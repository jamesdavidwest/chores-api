	...
	return (
		knex.schema
			...
			.createTable("events", (table) => {
				...
				table.integer("frequency_id").references("id").inTable("frequency_types");
				table.integer("assigned_to").references("id").inTable("users");
				table.integer("template_id").references("id").inTable("event_templates");

				// User tracking
				table.integer("assigned_by").references("id").inTable("users").notNullable();
			...
			.createTable("event_instances", (table) => {
				...
				table.json("metadata");
				table.integer("parent_instance_id").references("id").inTable("event_instances");
			...
			.createTable("instance_ranges", (table) => {
				...
				table.integer("generated_by").references("id").inTable("users").notNullable();
			...
			.createTable("event_dependencies", (table) => {
				table.increments("id").primary();
				table.integer("event_id").references("id").inTable("events").onDelete("CASCADE");
				table.integer("dependent_event_id").references("id").inTable("events").onDelete("CASCADE");
			...
			.createTable("event_verifications", (table) => {
				table.increments("id").primary();
				table.integer("instance_id").references("id").inTable("event_instances").onDelete("CASCADE");
				table.integer("verified_by").references("id").inTable("users").notNullable();
			...
			.createTable("event_approvals", (table) => {
				table.increments("id").primary();
				table.integer("instance_id").references("id").inTable("event_instances").onDelete("CASCADE");
				table.integer("approver_id").references("id").inTable("users").notNullable();
			...
			.createTable("event_audit_logs", (table) => {
				...
				table.integer("instance_id").references("id").inTable("event_instances");
			...
			.createTable("event_acceptance_results", (table) => {
				table.increments("id").primary();
				table.integer("instance_id").references("id").inTable("event_instances").onDelete("CASCADE");
				table.integer("criteria_id").references("id").inTable("event_validation_rules");
